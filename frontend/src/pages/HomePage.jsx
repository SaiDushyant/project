...
export default function HomePage() {
  ...
  const heroSlides = [
    ...
    },
    {
      id: 2,
      image:
        "https://images.unsplash.com/photo-1572375927902-e60599bed90c?w=1600&q=80",
      title: "Stick",
      subtitle: "Stickers",
  ...
  const handleSpin = async () => {
    ...
    setTimeout(async () => {
      ...
      if (result === "Spin Again") {
        ...
        setWheelResult(null);
        alert(
          "🎉 You won 'Spin Again'! You got an extra free spin immediately! Try your luck again!",
        );
      } else {
  ...
  const handleClaim = async () => {
    ...
    const giftProductMap = {
      "Free Charm": {
        ...
        price: 0,
        image:
          "https://images.unsplash.com/photo-1590548784585-645d2b65306a?w=600&q=80",
        category: "Charms",
        isFreeGift: true,
      },
      "Free Stickers": {
        ...
        price: 0,
        image:
          "https://images.unsplash.com/photo-1589051030483-e30739c83218?w=600&q=80",
        category: "Stickers",
        isFreeGift: true,
      },
      "Free Squishy": {
        ...
        price: 0,
        image:
          "https://images.unsplash.com/photo-1559124391-c6e50c777b08?w=600&q=80",
        category: "Squishies",
        isFreeGift: true,
      },
    };
  ...
  return (
    <div className="page home-page">
      ...
      <section
        className="reveal summer-capsule-section"
        style={{
          padding: "100px 32px",
          backgroundImage:
            'linear-gradient(var(--glass-bg), var(--glass-bg)), url("https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1600&q=80")',
      ...
      >
        ...
        >
          Summer <span>Holiday</span> Capsule
        </h2>
        <p
          style={{
            maxWidth: "600px",
        ...
        >
          Limited edition beach-vibes badges, magnets, and sun-proof stickers.
          Catch them before the tide goes out! 🌊
        </p>
        <button
      ...
      <section className="hero reveal">
        <div className="hero-content-split">
          <div className="hero-text-side">
            <h1>
              Handcrafted <span>Happiness.</span> Curated{" "}
              <span>Collectibles.</span>
            </h1>
            <p>
              Elevate your everyday with premium badges, magnets, stickers,
              posters, bookmarks, and figurines designed to bring art,
              personality, and fandom into every corner of your life.
            </p>
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <h2
            style={{
              ...
              fontWeight: 800,
              margin: "20px 0",
              textShadow: "0 0 15px rgba(var(--primary-rgb), 0.4)",
              color: "white",
            }}
          >
            The Akara <span>Mystery Box</span>
          </h2>
          <p
            style={{
              maxWidth: "700px",
          ...
          >
            Discover the thrill of surprise with our curated Mystery Boxes
            available in ₹499, ₹999, and ₹1499 variants — each packed with
            collectibles and goodies worth more than what you pay for. From
            stickers and badges to charms, posters, bookmarks, magnets,
            figurines, and exclusive extras, every box is designed to feel
            personal, exciting, and unique.
          </p>
          <button
            className="btn btn-white-pill anime-btn-glow"
            onClick={() =>
              user ? setShowMysteryModal(true) : navigate("/login")
            }
          >
      ...
      <section className="reveal" style={{ padding: "80px 32px" }}>
        ...
        >
          ...
          <h2 className="section-title">
            The Akara <span>Gallery</span>
          </h2>
          <p style={{ color: "var(--gray)" }}>
            Join 1,000+ collectors sharing their keepsakes. Tag @my__akara to
            get featured.
          </p>
        </div>
        <div
      ...
      <section className="process-section reveal">
        ...
        <div className="process-grid">
          <div className="process-card">
            ...
            <p>
              Every collection is thoughtfully assembled with unique designs,
              trending fandoms, and creative aesthetics chosen to match your
              style and interests.
            </p>
          </div>
          <div className="process-card">
            ...
            <p>
              From badges and stickers to figurines and charms, each piece is
              made using premium materials and detailed finishing for a
              collectible-worthy feel.
            </p>
          </div>
          <div className="process-card">
            <span className="process-icon">🎁</span>
            ...
            <p>
              Your keepsakes are carefully packed in our signature boxes, ready
              to be gifted or cherished.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="stats-bar reveal">
        <div className="stats-inner">
          ...
          <div className="stat-item">
            ...
            <div className="stat-label">Stars - Average Rating</div>
          </div>
        </div>
      </div>
          ...
          {[
            {
              ...
              a: "Standard shipping takes 3-5 business days. Express shipping is available for next-day delivery in most cities.",
            },
            {
              q: "Can I customize my order?",
              a: "Yes! We specialize in custom badges, magnets, and plaques. Simply head to our custom studio section in the shop.",
            },
            {
              q: "What materials do you use?",
              a: "We use premium eco-friendly materials, including recycled metals, genuine leather, and sustainable wood.",
            },
          ].map((faq, i) => (
            <div
              key={i}
          ...
          {[
            {
              n: "Vidhya",
              r: "Happy Customer",
              t: "The badges were of excellent quality and they really elevated my aesthetic experience.",
            },
            {
              n: "Savitri",
              r: "Happy Customer",
              t: "I got a custom plaque made by Akara, and loved the thoughtfulness behind the crafted outcome.",
            },
            {
              n: "Priya",
              r: "Happy Customer",
              t: "The packaging was very neat and shipping was very prompt. Highly recommended!",
            },
          ].map((rev, i) => (
            <div
              key={i}
      ...
      {/* Founders Section */}
      <section
        className="founders-section reveal dark-section"
        style={{
          margin: "80px 32px",
          padding: "80px 40px",
          borderRadius: "32px",
      ...
      {/* Newsletter Section */}
      <section
        className="newsletter-section reveal dark-section"
        style={{
          marginBottom: "0",
      ...
      >
        <div className="newsletter-content">
          <h2>
            Join the <span>Akara Club</span>
          </h2>
          <p>
            Subscribe to get early access to new drops, exclusive events, and
          ...
          {newsletterStatus === "error" && (
            <p style={{ color: "#ef4444", marginTop: "12px", fontWeight: 700 }}>
      ...
      {user && (
        <div className="spin-trigger" onClick={() => setShowWheel(true)}>
          🎡
        </div>
      )}
      ...
      {showWheel && (
        ...
        >
          <div className="wheel-container" onClick={(e) => e.stopPropagation()}>
            ...
            <h2 style={{ fontFamily: "Outfit", fontWeight: 800 }}>
              Spin & <span>Save</span>
            </h2>
            ...
            {wheelResult ? (
              ...
              >
                <div>
                  ...
                  >
                    {wheelResult === "Try again next month"
                      ? "Result:"
                      : "Your Code:"}
                  </p>
                  <h3
      ...
      {showMysteryModal && user && (
        <div className="wheel-modal" onClick={() => setShowMysteryModal(false)}>
          ...
          >
            ...
            >
              Unlock your <span>Mystery Box</span>
            </h2>
            ...
            {mysteryStatus === "success" ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <p style={{ color: "var(--gray)", marginBottom: "24px" }}>
                  We'll get back to you shortly with details about your custom
                  mystery box.
                </p>
                <button
                  className="btn btn-primary"
              ...
              <>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      value={
                        mysteryName || user?.user_metadata?.full_name || ""
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={mysteryEmail || user?.email || ""}
                      onChange={(e) => setMysteryEmail(e.target.value)}
                      readOnly
                    />
                  </div>
                </div>
                ...
                >
                  Want a mix of themes? That works too. Simply mention your
                  favorite characters, series, artists, teams, aesthetics, or
                  interests in the customization box, and we'll curate a box
      ...
      {showSpinNotification && (
        ...
        >
          ...
          <div
            style={{ fontSize: "0.85rem", color: "#ccc", lineHeight: "1.4" }}
          >
            {canSpin
        ...
        <div className="wheel-modal" style={{ zIndex: 10000 }}>
          ...
          >
            ...
            {claimedCouponInfo.isFreeGift ? (
              ...
              >
                ⚠️ <b>Shipping Policy:</b> We cannot ship free gift products
                alone. When you purchase any other standard product, your free
                gift will be shipped with it together!
              </div>
            ) : (
              <div
                style={{
              ...
              >
                ⏳ Valid for exactly 2 days (expires{" "}
                {claimedCouponInfo.expiryDate}). After this, it will
